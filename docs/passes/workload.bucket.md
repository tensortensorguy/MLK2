...
**Category:** workload · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Buckets dynamic shapes into stable tuning buckets [1..32][33..128][129..512][513..2048]+.
...
## Legality conditions
Shape must be inferred.

## Accuracy impact
None.

## Performance impact
Enables cache hits across shapes.
