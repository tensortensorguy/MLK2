...
**Category:** ir · **Tier support:** T0-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Checks graph integrity: dangling ids, arity, use-def, outputs defined, acyclicity, effect-chain continuity, guard/GraphState presence, fact consistency.
...
## Legality conditions
Always legal to run; failing graphs block the pipeline.

## Accuracy impact
None.

## Performance impact
None (correctness gate).
