# `approx.function_lower`

**Category:** approximation · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Attaches implementation families to math functions (libm default; poly only when gated-allowed).
...
## Accuracy impact
poly family carries ULP certificate.

## Performance impact
Poly families are vectorizable.
