...
**Category:** lowering · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Lowers the graph to KernelModule: elementwise loops (fused), matmul via runtime entrypoint with tile params (spec §12).
...
## Accuracy impact
Preserves effect order (Rule 146).

## Performance impact
Kernel-level execution plan.
