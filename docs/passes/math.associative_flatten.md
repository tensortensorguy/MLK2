...
## Purpose
Flattens associative chains — active only when the profile/contract allows reassociation (Rule 33).
...
## Legality conditions
Reassociation must be explicitly permitted.

## Accuracy impact
FP reassociation changes rounding; gated.

## Performance impact
Enables balancing/fusion.
