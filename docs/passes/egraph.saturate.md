...
**Category:** e-graph · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Applies rewrite rules as class unions — nothing is destroyed; strict node/iteration budget.
...
## Legality conditions
Identity + pow/mul rules; profile-gated (Rule 90).

## Accuracy impact
None (non-destructive).

## Performance impact
Budgeted fixpoint (Rule 10).
