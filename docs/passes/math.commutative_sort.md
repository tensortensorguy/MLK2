...
## Purpose
Sorts commutative operands by canonical hash for CSE/pattern stability.
...
## Legality conditions
Requires definite Commutative fact.

## Accuracy impact
None (reordering operands of commutative ops).

## Performance impact
Improves CSE hit rate.
