...
**Category:** property · **Tier support:** T0-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Infers mathematical facts (commutativity, associativity, ranges, periodicity, differentiability) from ops, operand domains, and profile laws.
...
## Legality conditions
Unknown stays Unknown (Rule 22); profile laws gate FP reassociation facts.
