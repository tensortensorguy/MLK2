...
**Category:** backend · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Materializes the kernel artifact (serialized KernelModule; C++ source via the CPU backend) + fallback metadata (Rule 100).
...
## Accuracy impact
Artifact carries the accuracy story.

## Performance impact
Executed by mlk_backend_cpu.
