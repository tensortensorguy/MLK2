# `schedule.region_extract`

**Category:** schedule · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Extracts candidate kernel regions from fusion annotations.
