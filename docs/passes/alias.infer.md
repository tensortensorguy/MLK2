...
**Category:** alias · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Establishes may-alias facts: distinct placeholders never alias; node results are fresh.
...
## Performance impact
Enables vectorization legality (Rule 36).
