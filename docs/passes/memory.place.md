...
**Category:** memory · **Tier support:** T1-T3 · **Kill switch:** yes (Rule 60/150)

## Purpose
Assigns memory spaces from the target description (Rule 31: no hardcoded hardware).
